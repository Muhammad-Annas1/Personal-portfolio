      ...
      >
        ...
        <div className="lg:flex-grow md:w-[60%] lg:pl-14 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
          ...
          <p className="font mb-8 leading-relaxed text-left ">
            ...
            TailwindCSS to create responsive and functional websites. Looking ahead, 
            I&apos;m also planning to dive deeper into frameworks like React and Next.js, 
            a powerful framework to enhance and deliver high-quality modern web solutions. 
            My goal is to combine my passion for learning with technical expertise to create 
            efficient, user-friendly digital experiences. Let&apos;s collaborate and bring 
            your ideas to life!
          </p>
